...
const PRESTATION_BY_SLUG = {
  ...
  "diagnostic-electronique": ["diagnostic", "voyantMoteur", "mecanique", "tarifs"],
  "diagnostic-securite": ["entretien", "freins", "diagnostic", "tarifs"],
  "changement-bougies": ["entretien", "mecanique", "tarifs", "contact"],
  "filtre-habitacle": ["entretien", "rechargeClim", "tarifs"],
  "liquide-refroidissement": ["entretien", "mecanique", "tarifs", "contact"],
  ...
  injecteurs: ["mecanique", "diagnostic", "tarifs", "contact"],
  "vanne-egr": ["mecanique", "diagnostic", "tarifs", "contact"],
  "courroie-accessoires": ["mecanique", "batterie", "tarifs"],
  ...
  "kit-roulement-arriere": ["mecanique", "pneumatiques", "geometrie", "tarifs"],
  "rotule-direction": ["mecanique", "geometrie", "tarifs", "contact"],
  ...
  demarreur: ["batterie", "diagnostic", "mecanique", "tarifs"],
