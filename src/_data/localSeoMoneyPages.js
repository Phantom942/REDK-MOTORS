...
const PAGES = {
  ...
  mecanique: { title: "Réparation auto", url: "/mecanique/" },
  entretien: { title: "Révision voiture", url: "/entretien/" },
  vidange: { title: "Vidange voiture", url: "/vidange/" },
  freins: { title: "Changement plaquettes frein", url: "/freins/" },
  pneumatiques: { title: "Changement pneus", url: "/pneumatiques/" },
  carrosserie: { title: "Réparation carrosserie", url: "/carrosserie/" },
  pareBrise: { title: "Remplacement pare-brise", url: "/pare-brise/" },
  rechargeClim: { title: "Réparation climatisation", url: "/prestations/recharge-clim/" },
  montagePneus: { title: "Changement pneus", url: "/prestations/montage-equilibrage/" },
  plaquettes: { title: "Changement plaquettes frein", url: "/prestations/plaquettes-disques/" },
